    ...
    <nav className="sticky top-0 z-50 bg-[#f4f4f0] border-b-4 border-black px-4 py-3">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <Link to="/" className="flex-shrink-0 flex items-center gap-2 group">
          <div className="w-10 h-10 bg-yellow-400 border-3 border-black rounded-lg flex items-center justify-center text-black font-display text-xl shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] group-hover:translate-y-[1px] group-hover:translate-x-[1px] group-hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] transition-all">
            DS
          </div>
        ...
        <div className="md:hidden flex items-center">
          <button
            ...
            className="p-2 border-3 border-black rounded-lg bg-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
          >
            {isMobileMenuOpen ? <X className="w-6 h-6 stroke-[3]" /> : <Menu className="w-6 h-6 stroke-[3]" />}
          </button>
        </div>
      </div>
      ...
      {/* Mobile Menu Content */}
      {isMobileMenuOpen && (
        <div className="md:hidden mt-4 pt-4 border-t-2 border-black flex flex-col gap-4 pb-2">
          {showFindWork && (
            <Link 
              to="/requests" 
              onClick={() => setIsMobileMenuOpen(false)}
              className="w-full text-center px-4 py-3 font-bold uppercase tracking-wider text-sm border-2 border-black rounded-lg bg-white text-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:bg-yellow-200"
            >
              Find Work
            </Link>
          )}
